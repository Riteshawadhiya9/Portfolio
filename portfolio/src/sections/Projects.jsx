...
const Projects = () => {
  ...
  const projectsData = [
    ...
    },
    {
      id: 3,
      image: Code_Reviewer,
      title: "AI_Code_Reviewer",
      description:
        "An AI-powered full-stack code review tool that helps developers write cleaner, safer, and more efficient code. Simply paste your code and get an instant in-depth analysis covering bug detection with severity levels, performance & complexity insights, security vulnerabilities, testability review, and prioritized fix suggestions with before/after code examples.",
      technologies: ["React.js", "Node.js", "Express.js", "Gemini API"],
      links: {
    ...
    },
    {
      ...
      title: "Snake_Game",
      description:
        "A classic Snake Game built with vanilla JavaScript where players control a snake to consume food and grow longer. Features include wall and self-collision detection, progressive difficulty, spacebar pause, high score persistence, and arrow key controls with a direction queue system. The game features smooth animations, responsive controls, and a clean, modern UI.",
      technologies: ["HTML", "CSS", "JavaScript"],
      links: {
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        >
          {links && links.github ? (
            ...
            <button
              disabled
              className="px-3 py-1.5 bg-slate-700/30 border border-slate-600 rounded-lg text-xs text-slate-600 cursor-not-allowed flex-1"
            >
              GitHub
            </button>
          )}
          {links && links.live ? (
            ...
            <button
              disabled
              className="px-3 py-1.5 bg-cyan-600/30 rounded-lg text-xs text-cyan-300/50 cursor-not-allowed flex-1"
            >
              Live Site
            </button>
          )}

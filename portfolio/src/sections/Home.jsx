...
const Home = () => {
  const roles = useMemo(() => ["MERN Stack Developer", "Web Developer","Competitive Programmer", "Tech Enthusiast", "Generative AI Enthusiast"], []);
...
useEffect(()=>{
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 py-18 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">

        <div className="flex flex-col justify-center h-full text-center lg:text-left relative lg:pr-8">

          <div className="w-full mx-auto lg:mx-0 max-w-[48rem]">
            <motion.div 
            ...
            <motion.h2 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#1cd8d2] via[#00bf8f] to-[#1cd8d2] drop-shadow-lg'
            
             initial={{ opacity: 0, y: 40 }}
             animate={{ opacity: 1, y: 0 }}
             transition={{ duration:1 }}

            >Hello, I'm <span className='text-white font-bold text-txl sm:text-7xl lg:text-8xl lg:whitespace-nowrap'>Ritesh Awadhiya  </span></motion.h2>
            ...
            >
              ...
              <a href="/Ritesh_Awadhiya_.pdf" download className="px-6 py-3 rounded-full text-lg font-medium text-black bg-white hover:bg-gray-200 shadow-lg hover:scale-105 transition-all">My Resume</a>
            </motion.div>
        ...
        <div className="relative hidden lg:block lg:pl-8">
          ...
          style={{
            right : "1px" , width : "min(12vw, 200px)" , height : "min(20vw, 350px)" , borderRadius: "30%",
